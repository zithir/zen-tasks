...
//localstorage.set('tasks', constants.tasksForCookies);
//localstorage.set('startDate', (moment('10-03-2019', constants.dateFormat).format(constants.dateFormat)))
// localstorage.remove('startDate');
...
class App extends React.Component {
    ...
    */
    getTasks() {
        ...
        while (dateObj.unix() <= this.todaysDate.unix()) {
    ...
    changeDate(date, dateType) {
        ...
        if (dateType === "start") {
            ...
            this.setState({todaysDateString: date})
        } else {
...
// If application is run for the first time (no start date is stored in cookies)
